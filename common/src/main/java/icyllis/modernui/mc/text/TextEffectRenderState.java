...
public record TextEffectRenderState(
    ...
    private void buildPass(@Nonnull VertexConsumer builder,
        ...
        for (int i = 0, e = flags.length; i < e; i++) {
            ...
            if ((bits & CharacterStyle.STRIKETHROUGH_MASK) != 0) {
                TextRenderEffect.drawStrikethrough(pose, builder, rx1, rx2, baseline, 0.0F,
                        r, g, b, a);
            }
            if ((bits & CharacterStyle.UNDERLINE_MASK) != 0) {
                TextRenderEffect.drawUnderline(pose, builder, rx1, rx2, baseline, 0.0F,
                        r, g, b, a);
            }
        }
    }
    ...
    public TextureSetup textureSetup() {
        return TextureSetupCompat.singleTextureWithLightmap(
